...
noun_pronouns_exclude_tags = ["PU", "PR", "PO"]
...
conjunctions_accept_tags_start_with = ["C"]
conjunctions_exclude_tags = ["CR"]
...
## Functional:
functional_accept_tags = ["AT0", "AVP"]
functional_accept_tags_start_with = ["C", "P", "X", "I", "V"]
functional_exclude_tags = ["CRD", "PO", "PU", "VV"]
functional_exclude_tags_start_with = []
## Content:
content_accept_tags = []
content_accept_tags_start_with = ["N", "V", "A"]
content_exclude_tags = ["VH", "VB", "VD", "VM", "AT"]
content_exclude_tags_start_with = []
## definite Articles
article_accept_tags = ["AT0"]
